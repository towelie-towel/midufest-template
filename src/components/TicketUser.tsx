	...
	return (
		...
		>
			<path
				...
				style='fill:#11111199;stroke:#222'
			/>
			<path
			...
			/>
			<path
				d='M264.9 288.8v108M646.8 221.6 41.2 328.4M664.4 170.5l-640.8 113'
				style={{ stroke: '#ccc', strokeDasharray: 8 }}
			/>
		</svg>
	)
}
...
const DEFAULT_USER_IMAGE =
	'https://avatarfiles.alphacoders.com/235/thumb-235557.png'
		...
		<div id='user-ticket' class='atropos relative'>
			<div class='atropos-scale'>
				<div class='atropos-rotate'>
					<div class={`atropos-inner relative ${true ? '' : 'blur-[2px]'}`}>
						{width > 720 ? (
							<>
								<TicketLayout />
								<div
									data-atropos-offset='5'
									class='absolute inset-0 w-full flex justify-center top-[88px]'
								>
									<TicketLogo />
								</div>
							</>
							...
							<>
								...
								<div
									data-atropos-offset='5'
									class='absolute inset-0 w-full flex justify-center top-[65px]'
								>
									<TicketLogoMobile />
								</div>
							</>
						...
						<div class='-rotate-[10deg] italic absolute left-2/4 tablet:left-20 -translate-x-2/4 bottom-[193px] tablet:bottom-16 tablet:translate-x-0 mobile:bottom-[200px] flex tablet:flex-col justify-center text-center gap-1 items-center'>
							<span
								...
								class='opacity-70 text-sm tablet:text-base'
							>
								Ticket number
							</span>
